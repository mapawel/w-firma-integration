...
export const loaderCardData: CardData = {
    ...
    icon: <Upload className="w-20 h-24 fill-secondaryLight" />,
...
export const invoicesCardData: CardData = {
    ...
    icon: <Data className="w-20 h-24 fill-secondaryLight" />,
    path: ClientRoutes.INVOICES
};

export const loaderSaleCardData: CardData = {
    title: "Loader faktur sprzedaży",
    description:
        "Wystawiaj zbiorczo faktury sprzedaży na bazie pliku loadera.",
    icon: <Upload className="w-20 h-24 fill-secondaryLight" />,
    path: ClientRoutes.UPLOAD_SALE
};

export const saleCardData: CardData = {
    title: "Przegląd faktur sprzedaży",
    description:
        "Przeglądaj wcześniej załadowane faktury sprzedaży. Sprawdź status pozycji.",
    icon: <Sale className="w-20 h-24 fill-secondaryLight" />,
...
export const settingsCardData: CardData = {
    ...
    icon: <Settings className="w-20 h-24 fill-secondaryLight" />,
