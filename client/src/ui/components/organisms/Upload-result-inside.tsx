    ...
    return (
        <>
            ...
            <div className="mb-8 flex gap-10">
                <div>
                    <h3 className="text-xl">{viewType === UploadTypeEnum.SALE ? "Kod klienta:" : "Dostawca:"}</h3>
            ...
            <div className="mb-10 flex gap-4">
                ...
                >
                    {viewType === UploadTypeEnum.SALE ? "ŁADUJ REZERWACJĘ DO W-FIRMY!" : "ŁADUJ ZAMÓWIENIE DO W-FIRMY!"}
                </button>
                <button
