...
describe('permissions', () => {
    ...
    //         //given
    //         const permissions = [
    //             PermissionsEnum.READ_PRODUCTS,
    //             PermissionsEnum.ADD_PRODUCTS,
    //         ];
    //         //when
    //         class Example {
    ...
    //         //given
    //         const permissions = [PermissionsEnum.READ_PRODUCTS];
    ...
    //         //given
    //         const permissions = [PermissionsEnum.ADD_PRODUCTS];
    //         const mockExecutionContext: Partial<
    //             Record<
    //                 jest.FunctionPropertyNames<ExecutionContext>,
    //                 jest.MockedFunction<any>
    ...
    //             >
    //         > = {
    //             get: jest.fn().mockReturnValue([PermissionsEnum.ADD_PRODUCTS]), // not permission match
    //         };
    //         const mockContext = mockExecutionContext as ExecutionContext;
    //         const mockReflectorInstance = mockReflector as Reflector;
    //         //when
