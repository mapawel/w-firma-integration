...
import { CreateReservationResDto } from '../../../integrated-systems/wfirma/create-reservation/dto/create-reservation-res.dto';

export abstract class CreateReservationBaseClass {
    ...
    public abstract createSystemReservation(
        productsIds: number[],
